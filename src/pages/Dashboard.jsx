    ...
    return (
        <div className="flex items-start">
            ...
            <div className="flex flex-col items-center mr-6">
                ...
                <div className={`w-8 h-8 rounded-full ${isActive ? 'bg-[#1E0771]' : 'bg-[#7872B6]'} flex items-center justify-center z-10`}>
                </div>
                {!isLast && (
            ...
            <div className="flex-1">
                <div className="flex justify-between items-start">
                    <h3 className={`text-2xl font-medium ${isActive ? 'text-[#1E0771]' : 'text-[#7872B6]'}`}>
                        {title}
                    </h3>
                    <span className={`${isActive ? 'text-[#1E0771]' : 'text-[#7872B6]'} ml-4 font-bold text-xl`}>{date}</span>
                </div>
            </div>
        </div >
    );
    ...
    return (
        <div className="flex flex-row h-full min-h-screen">
            ...
            <section className="lg:flex-4 flex-3 flex flex-col p-8 pl-20 gap-8 ">
                ...
                <div>
                    <h2 className="text-secondary text-3xl font-semibold">Hello Berka Aldizar Ganteng!</h2>
                </div>
                ...
                <div className="flex flex-row">
                    <div className="flex-1 bg-[#EBF2FF] py-16 flex flex-col place-items-center gap-4 rounded-xl text-secondary h-fit" >
                        ...
                        <h4 className="text-xl ">Web Programming</h4>
                    </div>
